...
$idpermiso = $_GET['permisos'];

  $consulta_registro_permiso = "SELECT * FROM permisos 
  WHERE idpermisos_aj='".$idpermiso."' ";
$resultado_registro_permiso = $conexion->query($consulta_registro_permiso);

while ($rowUsuario=$resultado_registro_permiso->fetch_assoc()){
  $idper = $rowUsuario['idpermisos_aj'];
  $nombrePermiso= $rowUsuario['permisos'];
...
<div id="contenedor-primario" class="contenedor-primario container-fluid aling-items-center d-flex ">
  <div id="contenedor-segundario" class="contenedor-segundario  ">
    <div class="nombre-tabla container-fluid d-flex justify-content-center bg-danger">
      ...
      <h4 class="text-white"> P E R M I S O S</h4>
    </div>
    <div class="formulario ">
      <form class="" action="" method="POST">
        ...
        <div class="input-edit input-group mb-3 estatus ">
          ...
          <input class="form-control" type="text" id="editar-estatus" name="editar-permiso" autocomplete="off" value="<?php echo $nombrePermiso; ?>" placeholder="Dependencia" onkeypress="return soloLetras(event);"><br>
        </div>
...
<script type="text/javascript">
  ...
  botonCancelar.addEventListener("click", function() {
    window.location.href = "./registro-ausencia.php";
  })
</script>
...
if (isset($_POST['boton-guardar'])) {
  if (empty($_POST['editar-permiso'])) {
?>
    <script type="text/javascript">
      Swal.fire({
        title: 'Verificar!',
        text: 'Verifique si el campo esta lleno',
        icon: 'warning',
    ...
    $id = $_POST['idper'];
    $editar_permiso = $_POST['editar-permiso'];
    $consulta2 = "UPDATE permisos SET  permisos='$editar_permiso' WHERE idpermisos_aj='$id'";
    ...
    ?>
      <script type="text/javascript">
        Swal.fire({
          ...
          confirmButtonText: false,
          showConfirmButton: false,
          html: 'El permiso se actualizó correctamente, para cerrar la alerta dele click al boton <b>Aceptar</b> ',
          footer: '<a href="./registro-ausencia.php" class="boton-alerts-verde">ACEPTAR</a>',
