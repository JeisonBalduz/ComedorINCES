...
$sql = "SELECT COUNT(idusuario) as count FROM usuario ";
...
while($row = $result->fetch_assoc()) {
    $data[] = array(
        ...
        "rol" => $row['rol'],
        "activado" => $row['activo_us'],
        "actions" => ' <button class="boton-verde boton-configuracion" 
        type="button" name="actualizar">Configuración
        </button>
