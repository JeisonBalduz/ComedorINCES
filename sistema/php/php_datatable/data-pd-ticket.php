...
$sql = "SELECT COUNT(idticket) as count FROM ticket ";
...
$sql = "SELECT * FROM ticket INNER JOIN personal ON ticket.idpersonal = personal.idpersonal
...
ticket.comida like '%$searchValue%' )  ORDER BY idticket ASC LIMIT $start, $length";
$result = $conn->query($sql);
